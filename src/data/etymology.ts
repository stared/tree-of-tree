...
export const TREE: EtymNode = {
  ...
  children: [
    ...
    // ═══════════ Latin dūrus — claimed here by Watkins, REJECTED by de Vaan ═══════════
    {
      ...
      sense: "firm",
      disputed: true,
      note: "Watkins/AHD file dūrus here; but de Vaan derives it instead from *du(e)h₂-ró- 'long, far' (Skt dūrá 'far', Gk dērós 'long') — a different root entirely. The whole endure/durable family rides on this contested step.",
